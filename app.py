...
app = flask.Flask(__name__,static_folder='C:\\Users\\Mainak\\PycharmProjects\\Recommender\\movie_posters')
...
def comedy():
    return flask.render_template('comedy.html')
@app.route('/crime.html')
def crime():
    return flask.render_template('crime.html')
@app.route('/drama.html')
def drama():
    return flask.render_template('drama.html')
@app.route('/fantasy.html')
def fantasy():
    return flask.render_template('fantasy.html')
@app.route('/romance.html')
def romance():
    return flask.render_template('romance.html')
@app.route('/scifi.html')
def scifi():
    return flask.render_template('scifi.html')
@app.route('/thriller.html')
def thriller():
    return flask.render_template('thriller.html')
